          ...
          <div className="grid md:grid-cols-2 gap-4 text-sm">
            ...
            {profile.lawyerProfile && (
              <div>
                ...
                <p className="font-medium">{profile.lawyerProfile.licenseNumber}</p>
              </div>
            )}
          </div>
        </div>
              ...
              <div className="border-t pt-6">
                ...
                <div className="grid md:grid-cols-2 gap-4 mb-4">
                  <div>
                    ...
                    <input
                      ...
                      type="text"
                      required
                      defaultValue={profile.lawyerProfile.specialization}
                  ...
                  <div>
                    ...
                    <input
                      ...
                      required
                      min="0"
                      defaultValue={profile.lawyerProfile.experience}
                      className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500"
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <input
                      ...
                      min="0"
                      step="0.01"
                      defaultValue={profile.lawyerProfile.hourlyRate}
                      className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500"
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <input
                      name="availability"
                      type="text"
                      defaultValue={profile.lawyerProfile.availability || ""}
                ...
                <div>
                  ...
                  <textarea
                    name="bio"
                    rows={4}
                    defaultValue={profile.lawyerProfile.bio || ""}
