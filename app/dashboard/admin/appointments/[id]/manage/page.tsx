...
export default function AdminManageAppointmentPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="max-w-2xl mx-auto px-4">
        ...
        <h1 className="text-3xl font-bold mb-2">Manage Appointment (Admin)</h1>
        <p className="text-gray-600 mb-8">
          Administrative management of appointment
        </p>
        ...
        <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6">
          ...
          <p className="text-blue-800 text-sm">
            <span className="font-medium">Client:</span> {appointment.client.name} ({appointment.client.email})
          </p>
          <p className="text-blue-800 text-sm">
            <span className="font-medium">Lawyer:</span> {appointment.lawyer.name} ({appointment.lawyer.email})
          </p>
          <p className="text-blue-800 text-sm">
        ...
        <form onSubmit={handleSubmit} className="bg-white rounded-lg shadow p-6 space-y-6">
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-2">
              Admin Notes {action === "cancel" && "*"}
            </label>
            <textarea
              name="notes"
              rows={4}
              required={action === "cancel"}
              placeholder="Add administrative notes about this action..."
              className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500"
            />
          </div>
